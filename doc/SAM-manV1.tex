...
\end{eqnarray}
They can also be written in terms of an isoscalar and isovector components
\begin{equation}
{\cal A} = \frac{1}{4} \left[ 3 {\cal A}^{T=1} +  {\cal A}^{T=0}  \right] +
 \frac{1}{4} \left[  {\cal A}^{T=1} -  {\cal A}^{T=0}  \right] 
\vec{\tau}_0 \cdot \vec{\tau}_1
\end{equation}
For proton-proton, neutron-neutron and proton-neutron  scattering one has respectively 
\begin{equation}
{\cal A}_{\rm pp} &=& {\cal A}_{\rm nn} =    {\cal A}^{T=1} \nonumber \\
{\cal A}_{\rm pn} &=& \frac{1}{2} \left[  {\cal A}^{T=1} +  {\cal A}^{T=0}  \right] 
\end{equation}
...
\nonumber \\
-2i\mu {\mathcal{K}}_{0}\sum _{L''L'''}R_{L'L''}^{JST}({\mathcal{K}}',{\mathcal{K}}_{0})[1+2i\mu {\mathcal{K}}''R^{JST}({\mathcal{K}}_{0},{\mathcal{K}}_{0})]_{L''L'''}^{-1}
...
from the HO single particle wave functions according to:
\begin{equation}
\rho_{x}(q) = \sum_{n \ell}{\cal N}_{n \ell} \int r^2 dr 
\left[ R_{n \ell}    \right]^2 \frac{sin(qr)}{qr}
\end{equation} 
...
\end{eqnarray}
For example, for the case of For of $^{12}$C, for each cluster of protons 
...
We also consider a two-parameter fermi (2PF) matter density distribution 
\begin{equation}
...
\end{equation}
where {\em c} is the halfway radius, {\em a} the diffuseness parameter 
...
\caption{\label{Fig:mat_plan }NN general chronogram}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{\label{Fig:mat_plan }MSO general chronogram}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
ffact.f90  modules.f90  optpot.f90  rc2.f90  rc4.f90
dfold.f90       fform.f90  msomain.f90  rc1.f90     rc3.f90  xsec.f90

\begin{itemize}
\item \textbf{msomain.f90}main program
\item \textbf{rc1.f90}reads the input file and calls to the different subroutines
\item \textbf{rc2.f90}
\item \textbf{rc3.f90}
\item \textbf{rc4.f90}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
{\centering \includegraphics{mst_plan.eps} \par}
\caption{\label{Fig:mat_plan }MST generalchronogram}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
